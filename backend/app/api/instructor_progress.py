...
from app.models.class_system import ChapterProgress, ChapterProgressStatus, ClassMember, User, UserRole
...
async def get_analytics_overview(
    ...
    """获取班级统计分析数据"""
    from app.models.class_system import Chapter, Class, Test, TestResult

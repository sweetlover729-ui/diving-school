...
from app.models.class_system import User, UserRole, DocumentTemplate
...
class CourseCreateRequest(BaseModel):
    ...
    level: Optional[str] = "beginner"  # 级别: beginner/intermediate/advanced
    duration_days: Optional[int] = None  # 培训天数
    max_depth: Optional[int] = None  # 最大深度(米)
    is_active: bool = True
...
async def get_course_template(db: AsyncSession) -> Optional[DocumentTemplate]:
...
def parse_course_choices(template: Optional[DocumentTemplate]) -> List[dict]:
    """从模板中解析课程列表"""
